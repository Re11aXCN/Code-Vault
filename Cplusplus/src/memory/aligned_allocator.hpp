...
template <typename T, MemAlignPolicy Align = MemAlignPolicy::_64bytes>
...
template <typename T, MemAlignPolicy Align>
class aligned_allocator
{
public:
...
template <typename T, MemAlignPolicy TAlign, typename U, MemAlignPolicy UAlign>
