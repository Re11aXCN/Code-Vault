...
private:
    ...
    // 随机选择文件
    std::vector<std::string> randomSelectFiles(const std::vector<std::string>& files);
...
程序名字.exe --suffix=cpp --filter=[0.review.cpp, 2024.ICPC.Bridging the gap.cpp] --rand-num=5
*/